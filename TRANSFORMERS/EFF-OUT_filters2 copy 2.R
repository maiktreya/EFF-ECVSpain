...
filter_multi1 <- svyby(~np2_1, ~ nsitlabdom + bage, survey_weights, svymean, keep.var = F, na.rm = reduced) %>% data.table()
filter_multi1 <- filter_multi1[, year := sel_year][, var := "np2_1_homeownership"][, reduced := as.character(reduced)]
